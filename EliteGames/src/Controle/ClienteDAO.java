 ...
 */
 ...
 String sql = "INSERT INTO cliente(nome,cpf,rg,telefone,email,cep,cidade,bairro,logradouro)" +
 " VALUES(?,?,?,?,?,?,?,?,?)";
 ...
 pstm.setString(9, cliente.getLougradouro()); 
